...
// Adapted from http://wiki.unity3d.com/index.php/DetectTouchMovement

public class TouchGestures : BackModule<TouchGestures> {
	...
	public float TurnAngleDelta {get{return turnAngleDelta;}}
	...
	public float PinchDistanceDelta{get{return pinchDistanceDelta;}}
	...
	{
		Debug.Log ("Touch Gestures Initialized");
	}
	...
	{
		Debug.Log("TouchGestures Terminated");
	}
